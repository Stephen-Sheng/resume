...
import {Page, Text, StyleSheet, Document, Font, PDFDownloadLink} from '@react-pdf/renderer';
...
export const DownloadLink = () => {
  return(
      <PDFDownloadLink document={<ResumeTemplate />} fileName="resume.pdf" style={{ textDecoration:"none", color:"white"}}>
          Download
      </PDFDownloadLink>
  )
}