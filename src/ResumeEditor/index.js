...
export default function ResumeEditor({resumeId}) {
    ...
    const [resumeData, sendQueryResume] = useResource((id) => ({
    ...
    useEffect(() => {
        if (resumeId) {
            sendQueryResume(resumeId)
        }
    }, [resumeId])

    useEffect(() => {
        if (!resumeData.isLoading && resumeData.data) {
            let data = resumeData.data.data
                ...
                <>
                    <div style={{backgroundColor: "#353944"}}>
                        <ResumeAppBar profile={{
                            ...
                            profSkills,
                            otherSkill
                        }} resumeName={resumeName} setResumeName={setResumeName} resumeId={resumeId} bestDegree={bestDegree} bestUniv={bestUniv}/>
