...
export default function JobBar(props) {
    ...
    return (
        <Grid container spacing={0} style={{
            ...
            <Grid item xs={2.5} >
                <div style={{fontSize: "26px", fontWeight: "500", color: "#f64", paddingTop: "1.5em"}}> {jobData.salary} </div>
            </Grid>
            <Grid item xs={3} style={{paddingTop: "3em", textAlign: "center"}}>
            ...
            <Grid item xs={4}
                ...
                fontSize={"small"}/>{jobData.city}
            </Grid>
            <Grid item xs={5.5}>
                <div style={{fontSize: "14px", color: "#c6c9cf"}}> Published in {jobData.releasedate}</div>
