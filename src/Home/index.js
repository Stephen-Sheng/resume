    ...
    return (
        <div style={{backgroundColor:"black"}}>
            ...
            <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }} style={{ marginTop: "0.5%" }}>
                ...
                <Grid item xs={2} sm={4} md={4} style={{ textAlign: "center" }}>
                    <Button variant="contained" style={{borderRadius:"40px", backgroundImage:"linear-gradient(90deg,#ff813a,#ff3d3d)", height:"150%", fontWeight:"550"}}>Generate a free professional CV</Button>
                </Grid>
            </Grid>
            <Player
                className="my-player"
